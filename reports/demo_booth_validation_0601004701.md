...
| --- | --- | ---: | --- | --- |
| readiness and live stack | PASS | 1.9s |  | Health ok=True failing=[]<br>Readiness summary ok=9 warn=3 fail=0 |
...
| NemoClaw npm policy toggle and OpenShell rules | PASS | 14.9s |  | Toggled npm with dry-run/apply/restore; this validates a non-Brave preset path. |
  ...
  "assignment": {
    "assignments": {
      "nemoclaw-demo-e2e-0530182359": [
        "Booth Researcher 0601004701",
        "Booth Crab 0601004701"
      ]
    },
  ...
  "profiles": [
    {
      ...
      "headwear": "generated",
      "name": "Booth Researcher 0601004701",
      "role": "researcher",
      "runtime": "openclaw",
      "skills": [],
      "species": "lobster"
    ...
    },
    {
      ...
      "generated_headwear_kind": "beanie",
      "headwear": "generated",
      "name": "Booth Skill Coder 0601004701",
      "role": "coder",
      "runtime": "openclaw",
      "skills": [
        "coding-agent"
...
{
  "clear": {
    "archive": "/sandbox/archives/clear-20260531T164727Z",
    "archived_count": 8,
    "cleared": [
      "/sandbox/workspaces",
      "/sandbox/runs"
