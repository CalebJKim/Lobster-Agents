...
class QueryIntake:
    ...
    def finish_general_query(self) -> None:
        ...
        self._office_state.current_query = None
        self._office_state.current_files = []
    ...
    async def _process_one(self, query_data: dict[str, Any]) -> None:
        ...
        self._office_state.current_query = query_text
        self._office_state.current_files = files
        ...
        for agent in available:
            ...
            self._office_state.update_agent_position(agent.name, agent.location, agent.position)
            state = self._office_state.agent_states.setdefault(agent.name, {})
