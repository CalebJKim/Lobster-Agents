...
back through OpenClaw. Until a demo host provides ``NEMOCLAW_REEF_HERMES_COMMAND``,
...
from .nemoclaw_cli import _which
    ...
    if not command:
        return _failure(
            ...
            message=(
                ...
                "NEMOCLAW_REEF_HERMES_COMMAND on the backend host to enable crab runs."
            ),
