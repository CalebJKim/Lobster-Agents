"""Shared mutable reef state visible to all agents."""
...
from nemoclaw_reef.models import Action, ActionType, AgentState, Position
...
class ReefState:
    """Central store for everything that is happening in the reef."""
    ...
    def register_agent(
        ...
        self.agent_states[name] = {
            ...
            # reef_state so the /state REST snapshot carries it too,
            # otherwise a refreshReefState() call after spawn clobbers
